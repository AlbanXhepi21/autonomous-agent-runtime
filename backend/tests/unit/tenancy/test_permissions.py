...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Role.OWNER, Permission.DELETE_DATA_SOURCES, True),
        ...
        (Role.ADMIN, Permission.DELETE_DATA_SOURCES, False),
        ...
        (Role.ANALYST, Permission.DELETE_DATA_SOURCES, False),
        ...
        (Role.VIEWER, Permission.DELETE_DATA_SOURCES, False),
